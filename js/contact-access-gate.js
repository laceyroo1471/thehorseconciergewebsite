/**
 * Shared "get contact details" panel — web account primary, labeled app store links secondary.
 * @param {string} [returnPath] — path to return after sign-in (e.g. /providers/foo)
 */
(function (root) {
  function renderContactAccessGate(returnPath) {
    var path = returnPath || '/find-providers';
    var signInUrl =
      '/sign-in?return=' + encodeURIComponent(path);
  ...
  root.ThcContactAccessGate = { render: renderContactAccessGate };

  if (typeof module !== 'undefined' && module.exports) {
    module.exports = { renderContactAccessGate: renderContactAccessGate };
  }
